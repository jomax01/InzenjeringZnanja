...
<body>
    <h1>Enter Computer Specifications</h1>
    <form action="EvaluateServlet" method="post">
        ...
        <select id="powerSupply" name="powerSupply">
            ...
            <option value="1100" <%= "1100".equals(request.getParameter("powerSupply")) ? "selected" : "" %>>1100 W</option>
        ...
        <select id="gpuModel" name="gpuModel">
            ...
            <option value="nvidia quadro rtx 4000" <%= "nvidia quadro rtx 4000".equals(request.getParameter("gpuModel")) ? "selected" : "" %>>Nvidia Quadro RTX 4000</option>
        </select><br>
